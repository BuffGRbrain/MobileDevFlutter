              ...
              children: [
                TextField(
                  ...
                  onChanged: (String value) {
                    controller.setMode(int.parse(value));
                  },
                  maxLength: 1,
                ),
                TextField(
                  ...
                  keyboardType: TextInputType.number, //limitamos input a numero
                  onChanged: (String value) {
                    controller.modoJuego.value == 0
                        ? controller.setDificultySol(int.parse(value))
                        : controller.setDificultyMult(int.parse(value));
                  }, //Si es multijugador almacenamos el valor.
                  maxLength: 1,
                ),
                ElevatedButton(
                  onPressed: () => controller.multSol(),
                  child: Text('Que inicie el juego'),
                ),
                ElevatedButton(
                    onPressed: () => controller.letalmode(),
                    child: Text('Letal'))
              ],
            )),
      ),
